...
export default function Catering() {
  return (
    <div className="service-page">
      <h1 className="service-title">Catering</h1>

      <div className="image-grid">
        <div className="image-box">
          <img src="/images/catering1.jpg" alt="Catering service 1" />
        </div>
        <div className="image-box">
          <img src="/images/catering2.jpg" alt="Catering service 2" />
        </div>
        <div className="image-box">
          <img src="/images/catering3.jpg" alt="Catering service 3" />
        </div>
        <div className="image-box">
          <img src="/images/catering4.jpg" alt="Catering service 4" />
        </div>
      </div>
